...
class Logger : public rclcpp::Node
{
    ...
    private:
        ...
        rclcpp::Serialization<px4_msgs::msg::VehicleLocalPosition> serializer_local_pos_;
        ...
        void px4VehicleLocalPositionCB(const std::shared_ptr<px4_msgs::msg::VehicleLocalPosition> msg);
